...
class boron_author extends WP_Widget {
	public function boron_author() {
		$widget_options = array(
			'classname'   => 'boron_author',
			'description' => __('Display information about a person.', 'functionality-for-boron-theme')
		);
		parent::__construct('boron_author', __('Boron - About Author', 'functionality-for-boron-theme') , $widget_options);
	}
	...
	public function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'functionality-for-boron-theme'); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id('image_uri')); ?>"><?php _e('Image:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_name')); ?>"><?php _e('Author name:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_position')); ?>"><?php _e('Author position:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_facebook')); ?>"><?php _e('Author Facebook URL:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_youtube')); ?>"><?php _e('Author YouTube URL:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_twitter')); ?>"><?php _e('Author Twitter URL:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_googleplus')); ?>"><?php _e('Author Google+ URL:', 'functionality-for-boron-theme'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><?php _e('Author description:', 'functionality-for-boron-theme'); ?></label>
