...
class wpb_widget_followers extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			'boron-directory-followers', 

			// Widget name will appear in UI
			__('Boron - Followers', 'functionality-for-boron-theme'), 

			// Widget description
			array( 'description' => __( 'Just a simple widget that displays social icons with follower count.', 'functionality-for-boron-theme' ), ) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( $twitter_username != '' && $twitter_consumer_key != '' && $twitter_consumer_secret && $twitter_user_token && $twitter_user_secret ) {
			require_once SKYCLEANERS_PLUGIN . 'includes/twitterOauth/twitteroauth.php';
			...
			<div class="follow-me-twitter">
				<a href="https://twitter.com/'.esc_attr($twitter_username).'" class="social-icon icon-twitter" target="_blank"><span>'.$followers->followers_count.'</span> '.__('Followers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $facebook_username != '' ) {
			...
			<div class="follow-me-facebook">
				<a href="https://facebook.com/'.esc_attr($facebook_username).'" class="social-icon icon-facebook" target="_blank"><span>'.$data['0']->fan_count.'</span> '.__('Followers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $rss_feed != '' ) {
			...
			<div class="follow-me-rss">
				<a href="'.$rss_feed.'" class="social-icon icon-rss" target="_blank"><span>'.__('RSS', 'functionality-for-boron-theme').'</span> '.__('Subscribe', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $googleplus_username != '' && $googleplus_api != '' ) {
			...
			<div class="follow-me-googleplus">
				<a href="https://plus.google.com/'.$googleplus_username.'" class="social-icon icon-gplus" target="_blank"><span>'.$gplusfollowers.'</span> '.__('Followers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $youtube_username != '' && $youtube_api != '' ) {
			...
			<div class="follow-me-youtube">
				<a href="https://youtube.com/user/'.$youtube_username.'" class="social-icon icon-youtube" target="_blank"><span>'.$youtube_data->items['0']->statistics->subscriberCount.'</span> '.__('Subscribers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $vimeo_username != '' && $vimeo_access_token != '' ) {
			...
			<div class="follow-me-vimeo">
				<a href="https://vimeo.com/'.$vimeo_username.'" class="social-icon icon-vimeo" target="_blank"><span>'.$vimeo_data->total.'</span> '.__('Subscribers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $soundcloud_username != '' && $soundcloud_client_id != '' ) {
			...
			<div class="follow-me-soundcloud">
				<a href="https://soundcloud.com/'.$soundcloud_username.'" class="social-icon icon-soundcloud" target="_blank"><span>'.$soundcloud_data->followers_count.'</span> '.__('Followers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
		...
		if ( $instagram_username != '' && $instagram_token != '' ) {
			...
			<div class="follow-me-instagram">
				<a href="https://instagram.com/'.$instagram_username.'" class="social-icon icon-instagram" target="_blank"><span>'.$instagram_data->data->counts->followed_by.'</span> '.__('Followers', 'functionality-for-boron-theme').'</a>
			</div>';
		}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'maintitle' ) ); ?>"><?php _e( 'Widget title:', 'functionality-for-boron-theme' ); ?></label> 
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook_username' ) ); ?>"><?php _e( 'Facebook page ID:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_username' ) ); ?>"><?php _e( 'Twitter username:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_consumer_key' ) ); ?>"><?php _e( 'Twitter consumer key:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_consumer_secret' ) ); ?>"><?php _e( 'Twitter consumer secret:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_user_token' ) ); ?>"><?php _e( 'Twitter user token:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_user_secret' ) ); ?>"><?php _e( 'Twitter user secret:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'googleplus_username' ) ); ?>"><?php _e( 'Google+ page ID:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'googleplus_api' ) ); ?>"><?php _e( 'Google+ API key:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube_username' ) ); ?>"><?php _e( 'YouTube username:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube_api' ) ); ?>"><?php _e( 'YouTube API key:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo_username' ) ); ?>"><?php _e( 'Vimeo username:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo_access_token' ) ); ?>"><?php _e( 'Vimeo access token:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud_username' ) ); ?>"><?php _e( 'Soundcloud username:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud_client_id' ) ); ?>"><?php _e( 'Soundclient client ID:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_username' ) ); ?>"><?php _e( 'Instagram username:', 'functionality-for-boron-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_token' ) ); ?>"><?php _e( 'Instagram access token:', 'functionality-for-boron-theme' ); ?></label>
		...
		<hr></hr>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'rss_feed' ) ); ?>"><?php _e( 'RSS Feed:', 'functionality-for-boron-theme' ); ?></label>
